...
from scdebussy.tl import dtw_barycenter_averaging_with_categories
...
def test_dtw_barycenter_averaging_with_categories():
    ...
    barycenter, categories, aligned_barycenters = dtw_barycenter_averaging_with_categories(
        X=X, Y=Y, barycenter_size=5, max_iter=30, tol=1e-5, verbose=False
    )
    ...
    Y_numeric = np.array([[0, 0, 1, 1, 2], [0, 0, 1, 2, 2], [0, 1, 1, 2, 2]])

    barycenter2, categories2, aligned_barycenters2 = dtw_barycenter_averaging_with_categories(
        X=X, Y=Y_numeric, barycenter_size=5, max_iter=30, tol=1e-5, verbose=False
    )
    print(categories2)
...
def test_dtw_barycenter_averaging_with_categories_edge_cases():
    ...
    barycenter, categories, aligned_barycenters = dtw_barycenter_averaging_with_categories(
        X=X_single, Y=Y_single, barycenter_size=3
    )
